...
plot <- ggplot(pca_plot_data, aes(x = PC1, y = PC2)) +
  ...
  theme_minimal()
ggsave("figures/PCA: PC1 vs PC2", plot=plot)
plot2 <- ggplot(pca_plot_data, aes(x = PC1, y = PC3)) +
  ...
  theme_minimal()
ggsave("figures/PCA: PC1 vs PC3", plot=plot2)
plot3 <- ggplot(pca_plot_data, aes(x = PC2, y = PC3)) +
  ...
  theme_minimal()
ggsave("figures/PCA: PC2 vs PC3", plot=plot3)
```
...
plot4 <- ggplot(reduced_data, aes(x = PC1, y = PC2, color = Cluster)) +
  ...
  theme_minimal()
ggsave("figures/K-means Clustering on Principal Components", plot=plot4)
```
